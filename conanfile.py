...
class Antlr4Conan(ConanFile):
    ...
    def source(self):
        ...
        antlr_file_name = "antlr-{}-complete.jar".format(self.version)
        source_url2 = "https://www.antlr.org/download/{}".format(antlr_file_name)
    ...
    def package(self):
        ...
        shutil.move(os.path.join(self._source_subfolder, "antlr-{}-complete.jar".format(self.version)), "antlr.jar")
